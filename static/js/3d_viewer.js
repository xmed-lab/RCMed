...
async function init3DViewer() {
    ...
    try {
        ...
        console.log('Expected data length:', width * height * depth);
        console.log('Actual data length:', data.image.length);
                ...
                for (let z = 0; z < depth; z++) {
                    ...
                    if (idx >= data.image.length) {
                        console.error('Index out of bounds:', {
                            index: idx,
                            maxLength: data.image.length,
                            coordinates: {x, y, z},
                            dimensions: {width, height, depth}
                        });
                        throw new Error('Index out of bounds while processing volume data');
                    }
