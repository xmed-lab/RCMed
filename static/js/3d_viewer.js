...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!loadBtn || !loadContainer || !viewerContainer) {
    ...
    loadBtn.addEventListener('click', async () => {
        try {
            ...
            viewerContainer.innerHTML = '<div class="alert alert-danger m-3">Error loading 3D data: ' + error.message + '</div>';
        }
    });
});
